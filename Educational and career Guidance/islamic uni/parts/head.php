<div class="top">
				<div class="logo">
					<h2>IT TRAINERSS<br /><span style="color:#FFFF00; font-size:17px;">MARDAN</span></h2>
				</div>
				<div class="slogon">
					<h2>Achieving High <span style="color:#FFFF00;">Standards</span></h2>
				</div>
			</div> <!--top division close-->
			<div class="banner">
    ...
    <div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 1300px; height: 500px; overflow: hidden; visibility: hidden;">
        ...
        <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 1300px; height: 500px; overflow: hidden;">
            <div data-p="225.00">
                ...
                <div style="position: absolute; top: 30px; left: 30px; width: 480px; height: 120px; font-size: 50px; color: #ffffff; line-height: 60px;">IT TRAINERS MARDAN</div>
                <div style="position: absolute; top: 300px; left: 30px; width: 480px; height: 120px; font-size: 30px; color: #ffffff; line-height: 38px;">MUKAM CHOWK MARDAN</div>
			...
			<div data-p="225.00" style="display: none;">
                <img data-u="image" src="images/download.jpg" />
            </div>
			<div data-p="225.00" style="display: none;">
                <img data-u="image" src="images/map.png" />
            </div>
...
<ul>
   ...
   <li class='active has-sub'><a href='about.php'><span>About</span></a>
      <ul>
