...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <table width="855" height="174" border="1">
    ...
    <tr>
      <td colspan="6"><a href="addpara.php"><img src="images/add.png" /></a></td>
    </tr>
    <tr>
     ...
     <?php
      ...
      <tr>
        ...
        <td><div align="center"><img src="<?php echo $fetch['picture'] ?>" width="100" height="100"/></div></td>
        <td><div align="center"><a href="detail.php?id=<?php echo $fetch['id']; ?>"><?php echo  $detail?></a> </div></td>
        <td><div align="center"><a href="updatepara.php?id=<?php echo $fetch['id']; ?>"><img src="images/update.png" /></a></div></td>
